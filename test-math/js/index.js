...
window.onload = function() {
    if (login_email, login_sandi === null) {
        alert('Bạn Có Chắc Chắn Với Hành Động Này?')
        ...
        <h1 class="text-2xl mb-4">MAFOX<span class="animate-pulse">👋🏻</span></h1><br>
        <span class="hover:shadow-inner bg-slate-200 text-yellow-700 text-md font-mono px-1 shadow-lg py-0.5 rounded-md inline-block mb-3">Tên Tài Khoản : <span class="text-green-700">${valid_name}</span></span><br>
        ...
        <span class="hover:shadow-inner bg-slate-200 text-yellow-700 text-md font-mono px-1 shadow-lg py-0.5 rounded-md inline-block mb-3">Mật Khẩu : <span class="text-green-700">${valid_sandi}</span></span><br>
        </center>
        `
    }
}
